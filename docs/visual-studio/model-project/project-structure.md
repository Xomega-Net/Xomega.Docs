...
You can also [add new generators](../extend/generators#adding-new-custom-generators) or [clone and update existing configurations](configuring-generators#multiple-configurations).
