...
Generates customizable C# clients for REST services that implement the service interfaces generated by the [Service Contracts](../../services/contracts) generator, and can be registered with the DI container as the implementation of those interfaces on the client side.
