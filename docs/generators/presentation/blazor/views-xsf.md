...
The generated views extend base classes from the `Xomega.Syncfusion.Blazor` package, and are bound to their corresponding *View Models* that are generated using [View Models Generator](../common/view-models.md).
