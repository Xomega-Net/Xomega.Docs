...
<XomGeneratorConfig xmlns="http://schemas.xomega.net/v10/xgen"
  ...
  <Generator Xsl="UI/Blazor/syncfusion_views.xsl"
...
|-|-|-|
|Xsl|UI/Blazor/syncfusion_views.xsl|Relative path to the XSLT file used by the generator to generate the Xomega Syncfusion Blazor views.|
