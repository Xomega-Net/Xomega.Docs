...
The best way to understand the capabilities of our low-code platform, and appreciate the speed of the application development it provides, is to walk through the process of building a fully-fledged end-to-end application from scratch.
...
:::warning
This tutorial is based on [version 2022](https://github.com/Microsoft/sql-server-samples/releases/download/adventureworks/AdventureWorks2022.bak) of the AdventureWorks database.
