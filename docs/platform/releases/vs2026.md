...
- **Support for modifying Xomega Solution**
  - Support for easily [adding new projects](../../visual-studio/new-projects/adding-to-solution#adding-modern-projects) (Blazor, WPF, MAUI or SPA) to existing Xomega solutions.
  - Support for [switching to Syncfusion Blazor components](../../visual-studio/new-projects/adding-to-solution#switching-to-syncfusion-components) on existing Blazor projects with Xomega components.
...
- Fixed *Find in Files* search for `.xom` files in the model project.
- **Xomega solution wizard fixes**
  ...
  - *Framework* and *Authentication* are now populated from existing configuration and disabled in the solution wizard.
